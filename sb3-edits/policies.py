...
class RecurrentActorCriticPolicy(ActorCriticPolicy):
    ...
    def explainer_forward(
        ...
        return pi_features, vf_features, RNNStates(lstm_states_pi, lstm_states_vf), lstm_states_vf
    ...
    def forward(
        ...
        """
        # Preprocess the observation if needed
        # print("obs policies shape:", obs.shape )
        
        features = self.extract_features(obs)
        # print("features policies shape:", features.shape )
        if self.share_features_extractor:
            pi_features = vf_features = features  # alis
        else:
            pi_features, vf_features = features
